...
import type { ChannelBlocking } from '@/models/entities/ChannelBlockee.js';
import { QueueService } from '@/core/QueueService.js';
import { GlobalEventService } from '@/core/GlobalEventService.js';
import { DI } from '@/di-symbols.js';
import type { ChannelFollowRequestsRepository, ChannelBlockingRepository, UserListsRepository, UserListJoiningsRepository, ChannelFollowing } from '@/models/index.js';
...
@Injectable()
export class ChannelBlockerService implements OnModuleInit {
	...
	constructor(
		...
		@Inject(DI.channelBlockingRepository)
		private channelBlockingRepository: ChannelBlockingRepository,
	...
	@bindThis
	public async block(blocker: Channel, blockee: User, silent = false) {
		await Promise.all([
